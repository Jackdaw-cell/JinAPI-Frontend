...
/** invokeInterfaceInfo POST /api/interfaceInfo/invokeByPost */
export async function invokeInterfaceInfoByPOST(
  body: API.InterfaceInfoInvokeRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseobject>('/api/interfaceInfo/invokeByPost', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** invokeInterfaceInfo POST /api/interfaceInfo/invokeByGet */
export async function invokeInterfaceInfoByGET(
  body: API.InterfaceInfoInvokeRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseobject>('/api/interfaceInfo/invokeByGet', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function createSseClient(uid: string | number | undefined, options?: any) {
